...
if [ "${SENTRY_INGEST_FILTER_ENABLED:-false}" = "true" ]; then
  ...
  sentry-ingest-filter:
    ...
    environment:
      ...
      - MAX_ITEMS_PER_SIGNATURE_EVENT=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_EVENT:-5000}
      - MAX_ITEMS_PER_SIGNATURE_TRANSACTION=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_TRANSACTION:-5000}
      - MAX_ITEMS_PER_SIGNATURE_PROFILE=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_PROFILE:-5000}
      - MAX_ITEMS_PER_SIGNATURE_CHECKIN=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_CHECKIN:-5000}
      - MAX_ITEMS_PER_SIGNATURE_LOG=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_LOG:-5000}
...
EOF
    ...
    echo "MAX_ITEMS_PER_SIGNATURE_EVENT=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_EVENT:-5000}" >>"${SENTRY_DATA_PATH}/self_hosted/.z-ingest-filter-config.tmp.txt"
    echo "MAX_ITEMS_PER_SIGNATURE_TRANSACTION=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_TRANSACTION:-5000}" >>"${SENTRY_DATA_PATH}/self_hosted/.z-ingest-filter-config.tmp.txt"
    echo "MAX_ITEMS_PER_SIGNATURE_PROFILE=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_PROFILE:-5000}" >>"${SENTRY_DATA_PATH}/self_hosted/.z-ingest-filter-config.tmp.txt"
    echo "MAX_ITEMS_PER_SIGNATURE_CHECKIN=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_CHECKIN:-5000}" >>"${SENTRY_DATA_PATH}/self_hosted/.z-ingest-filter-config.tmp.txt"
    echo "MAX_ITEMS_PER_SIGNATURE_LOG=${SENTRY_INGEST_FILTER_MAX_ITEMS_PER_SIGNATURE_LOG:-5000}" >>"${SENTRY_DATA_PATH}/self_hosted/.z-ingest-filter-config.tmp.txt"
